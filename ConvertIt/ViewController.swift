...
//  ConvertIt
//
//  Created by oliver naser on 9/29/17.
...
class ViewController: UIViewController {
    ...
    let formulasArray = [Formula(conversionString: "miles to kilometers", formula: {$0 / 0.62137}),
                         ...
                         Formula(conversionString: "yards to meter", formula: {$0 / 1.0936}),
                         ...
                         Formula(conversionString: "quarts to literes", formula: {$0 / 1.05669}),
                         Formula(conversionString: "literes to quarts", formula: {$0 * 1.05669}),
                         ]
